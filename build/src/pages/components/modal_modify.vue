<template>
  <div class="modal fade" id="modal-modify" v-if="modalData" :key="modalData.id">
          ...
          <form id="modify-file" class="form-horizontal" @submit.prevent="writeSubmit" enctype="multipart/form-data">
            ...
            <div v-for="(link, index) in list.links">
              <div class="form-group">
                ...
                <div class="col-sm-1">
                  <button id="reset" type="button" v-on:click="removeApartment(index)" class="btn btn-block btn-danger">-
                  </button>
                </div>
              </div>
            </div>
